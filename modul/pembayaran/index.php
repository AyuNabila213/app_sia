...
<div class="card">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>BY110324</td>
                        <td>11/03/2024</td><td>Rp. 1.000.000,-</td>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5"id="exampleModalLabel">Edit Data Pembayaran</h1><button type="button" class="btn-close" data-bsdismiss="modal" aria-label="Close"></button>
                                        </div>
    ...
    <div class="col-md-6">
        <label for="keterangan" class="formlabel">Keterangan</label>97. <input type="text" class="form-control"
