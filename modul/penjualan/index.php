...
<form action="" method="post">
    <div class="modal-dialog modal-lg">106. <div class="modal-content">
...
<div class="col-md-3">
    <label for="harga" class="formlabel">Harga</label>143. <div class="input-group">
        <span class="input-group-text">Rp.</span>
...
<tr>
    ...
    <td>
        ...
        <a href="" class="text-decoration-none"><i class="bi bi-trash text-danger"></i>
    </a>
</td>
</tr>
</tbody>
